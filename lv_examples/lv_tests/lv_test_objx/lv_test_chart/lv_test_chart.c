...
void lv_test_chart_1(void)
{
    ...
    lv_chart_series_t * dl1_1 = lv_chart_add_series(chart1, LV_COLOR_BLACK);
    dl1_1->points[0] = 0;
    dl1_1->points[1] = 25;
    dl1_1->points[2] = 0;
    dl1_1->points[3] = 50;
    ...
    // lv_chart_series_t * dl1_2 = lv_chart_add_series(chart1, LV_COLOR_BLACK);
    // dl1_2->points[0] = 100;
    ...
    // lv_chart_series_t * dl2_1 = lv_chart_add_series(chart2, LV_COLOR_BLACK);
    // dl2_1->points[0] = 0;
    // dl2_1->points[1] = 25;
    // dl2_1->points[2] = 0;
    // dl2_1->points[3] = 50;
    ...
    // lv_chart_series_t * dl2_2 = lv_chart_add_series(chart2, LV_COLOR_BLACK);
    // dl2_2->points[0] = 100;
    ...
    // lv_chart_series_t * dl3_1 = lv_chart_add_series(chart3, LV_COLOR_BLACK);
    // dl3_1->points[0] = 0;
    // dl3_1->points[1] = 25;
    // dl3_1->points[2] = 0;
    // dl3_1->points[3] = 50;
    ...
    // lv_chart_series_t * dl3_2 = lv_chart_add_series(chart3, LV_COLOR_BLACK);
    // dl3_2->points[0] = 100;
