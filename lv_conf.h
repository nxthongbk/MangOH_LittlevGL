...
#define LV_TUTORIAL_HELLO_WORLD_H          1 
#define LV_TUTORIAL_FONTS_H                1 
#define LV_TUTORIAL_OBJECTS                1 
#define EX_OBJECTS_H                       1

#define USE_LV_FONT_MONOSPACE_8	   	   1
#define USE_LV_FONT_MONOSPACE_20	   0
#define USE_LV_FONT_SIJI                   1
...
/*Image (dependencies: lv_img)*/
#define USE_LV_IMG      1

/*Preload (dependencies: lv_img)*/
